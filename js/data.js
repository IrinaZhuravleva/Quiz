...
//      Settled - If the promise has been either Fulfilled or Rejected.
        ...
        // function being called.In apply we pass the arguments as an array and in call we pass the arguments directly in the argument list.
         ...
         'answer': 1
          ...
          'id': 44,
          'question': `Что выведет функция?<br >f();<br >
                        function f() { alert(1); }
                        var f = function() { alert(2); }; `,
          'answers': [{ 'id': 1, 'text': 'alert(1)' }, { 'id': 2, 'text': 'alert(2)' }, { 'id': 3, 'text': 'undefined' }],
          'answer': 1
       }, {
           'id': 45,
           'question': `Что выведет функция?<br >function styleHyphenFormat(propertyName) {<br >
            function upperToHyphenLower(match) {<br >
            return '-' + match.toLowerCase();<br >
            }<br >
            return propertyName.replace(/[A-Z]/g, upperToHyphenLower);<br >
            }<br ><br >

            styleHyphenFormat('borderTop');`,
           'answers': [{ 'id': 1, 'text': 'undefined' }, { 'id': 2, 'text': 'border-top' }],
           'answer': 2
        }, {
            'id': 46,
            'question': `console.log('1: ', test);<br >
                var test;<br >
                console.log('2: ', test);<br >
                test = 10;<br >
                console.log('3: ', test);<br >
                test += '20';<br >
                console.log('4: ', test);`,
            'answers': [{ 'id': 1, 'text': 'undefined//undefined//10//1020' }, { 'id': 2, 'text': 'undefined//undefined//10//30' }],
            'answer': 1
         }, {
             'id': 47,
             'question': `var name = 'Alex';<br >
                var city = 'Boston';<br ><br >
                var person = {<br >
                name: 'John',<br >
                city: 'Colorado',<br >
                logPersonInfo() {<br >
                ...
                function logInfo() {<br >
                console.log(\`This is \${this.name} from \${city}\`);}<br >
